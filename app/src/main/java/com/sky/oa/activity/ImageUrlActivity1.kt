...
// * 加载网络图片
// */
//class ImageUrlActivity1 : BaseMActivity<ActivityUrlBinding, ImageUriViewModel>() {
...
//    override fun createViewModel() = ViewModelProvider(this, object : ViewModelProvider.Factory {
//        override fun <T : ViewModel> create(modelClass: Class<T>): T =
//            ImageUriViewModel(ImageRepository()) as T
//    })[ImageUriViewModel::class.java]
//
...
//
//        viewModel.getLiveDataUrl().observe(this) {
//            val datas : MutableList<CourseEntity> = mutableListOf()
////            for ( i in 0..2){
////                datas.add(it[i])
